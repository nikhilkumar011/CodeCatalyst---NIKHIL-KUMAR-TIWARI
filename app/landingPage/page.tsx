...
export default function LandingPage() {
    return (
        ...
        <div className="relative min-h-screen overflow-hidden bg-[#05070d] text-[#F2F4F8] font-sans flex items-center">
            {/* Background glows */}
            <div
                className="pointer-events-none absolute inset-0 z-0"
                style={{
                    background:
                        "radial-gradient(circle at 20% 50%, rgba(79,125,243,0.08), transparent 50%), radial-gradient(circle at 80% 50%, rgba(155,93,229,0.08), transparent 50%)",
                }}
            />
            ...
            <main className="relative z-10 mx-auto max-w-[1200px] w-full px-6 py-12 lg:py-0 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                {/* Left Column - Visual Representation (Replacing the iPhones) */}
                <div className="relative h-[500px] w-full flex items-center justify-center lg:justify-start perspective-[2000px]">
                    {/* Back "Phone/Card" Mockup */}
                    <div className="absolute left-[10%] top-[10%] h-[420px] w-[260px] transform rounded-3xl border border-white/10 bg-[rgba(18,22,34,0.8)] shadow-[0_20px_50px_rgba(0,0,0,0.5)] backdrop-blur-xl transition-transform duration-700 hover:rotate-y-0 rotate-y-[15deg] rotate-z-[-5deg] p-6 flex flex-col gap-4">
                        ...
                        <div className="space-y-3 mt-2">
                            ...
                            <div className="h-2 w-[90%] rounded-full bg-white/10"></div>
                            <div className="h-2 w-[80%] rounded-full bg-white/10"></div>
                        </div>
                        <div className="mt-auto rounded-xl bg-white/5 p-4 border border-white/5">
                            <div className="flex items-center gap-2 mb-2">
                                <Sparkles size={14} className="text-[#34D399]" />
                                <div className="h-1.5 w-16 rounded-full bg-white/20"></div>
                            </div>
                            <div className="h-1.5 w-full rounded-full bg-white/10 mb-2"></div>
                    ...
                    <div className="absolute right-[15%] bottom-[5%] h-[440px] w-[280px] transform rounded-3xl border border-white/[0.15] bg-[#121622] shadow-[0_30px_60px_rgba(0,0,0,0.7)] backdrop-blur-2xl transition-transform duration-700 hover:rotate-y-0 rotate-y-[-10deg] rotate-z-[2deg] flex flex-col overflow-hidden">
                        ...
                        <div className="flex-1 p-6 space-y-5 bg-[rgba(18,22,34,0.6)]">
                            {[1, 2, 3].map((i) => (
                                <div key={i} className="flex gap-3">
                                    <div className="mt-1 h-4 w-4 shrink-0 rounded-full bg-gradient-to-br from-[#4F7DF3] to-[#9B5DE5] border border-white/20 flex items-center justify-center text-[8px]">✓</div>
                                    <div className="space-y-2 flex-1">
                        ...
                        <div className="p-4 border-t border-white/10 flex gap-2">
                            <div className="h-10 flex-1 rounded-xl bg-gradient-to-r from-[#4F7DF3] to-[#9B5DE5] flex items-center justify-center opacity-90 text-[11px] font-semibold tracking-wider">CHAT WITH PDF</div>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col items-center text-center lg:items-start lg:text-left z-20">
                    ...
                    <h1 className="mb-6 font-[Space_Grotesk,sans-serif] text-5xl font-bold leading-[1.1] tracking-tight sm:text-6xl lg:text-[64px] text-[#12131A] dark:text-[#F2F4F8]">
                        <span className="font-semibold tracking-wide text-[#F2F4F8]">Research AI</span>
                    </div>
                    
                    <h1 className="mb-6 font-[Space_Grotesk,sans-serif] text-5xl font-bold leading-[1.1] tracking-tight sm:text-6xl lg:text-[64px]">
    ...
    "
                    ...
                    <p className="mb-10 max-w-lg text-[17px] leading-relaxed text-[#A8AEBB]">
                        A new kind of AI assistant to help you tackle dense academic papers, extract key contributions, auto-generate flashcards, and chat directly with your documents.
                    </p>
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
                        <Link 
                            href="/root" 
                            className="flex h-14 w-full sm:w-auto items-center justify-center gap-2 rounded-xl bg-white px-8 font-semibold text-black transition-transform hover:scale-[1.02] active:scale-[0.98]"
                        >
                            <FileText size={20} />
                            Upload PDF Free
                        </Link>
