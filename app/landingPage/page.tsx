            ...
            <main className="relative z-10 mx-auto max-w-[1200px] w-full px-6 py-12 lg:py-0 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="relative h-[500px] w-full flex items-center justify-center lg:justify-start perspective-[2000px]">
                    ...
                    <div className="absolute right-[15%] bottom-[5%] h-[440px] w-[280px] transform rounded-3xl border border-black/[0.1] dark:border-white/[0.15] bg-white dark:bg-[#121622] shadow-[0_30px_60px_rgba(0,0,0,0.18)] dark:shadow-[0_30px_60px_rgba(0,0,0,0.7)] backdrop-blur-2xl transition-transform duration-700 hover:rotate-y-0 rotate-y-[-10deg] rotate-z-[2deg] flex flex-col overflow-hidden">
                        ...
                        <div className="p-4 border-t border-black/[0.08] dark:border-white/10 flex gap-2">
                            <div className="h-10 flex-1 rounded-xl bg-gradient-to-r from-[#4F7DF3] to-[#9B5DE5] flex items-center justify-center opacity-90 text-[11px] font-semibold tracking-wider text-white">
                                CHAT WITH PDF
                            </div>
                        </div>
                    </div>
                ...
                <div className="flex flex-col items-center text-center lg:items-start lg:text-left z-20">
                    <div className="mb-6 flex items-center gap-2">
                        ...
                        <span className="font-semibold tracking-wide text-[#12131A] dark:text-[#F2F4F8]">
                            Research AI
                        </span>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-5 items-center justify-center lg:justify-start w-full sm:w-auto">
                        <Link
                            href="/root"
                        ...
                        <Link
                            href="/about"
                            className="flex h-14 w-full sm:w-auto items-center justify-center rounded-xl px-8 font-semibold text-white bg-gradient-to-r from-blue-600 via-cyan-500 to-emerald-500 dark:from-violet-600 dark:via-fuchsia-600 dark:to-pink-600 shadow-lg shadow-blue-500/20 dark:shadow-violet-500/20 transition-all duration-300 hover:scale-[1.03] hover:shadow-xl active:scale-[0.98]"
                        >
                            About Briefly
                        </Link>
                    </div>
